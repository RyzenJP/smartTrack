<nav class="navbar navbar-expand-lg px-3">
  <div class="container-fluid">
    ...
    <a class="navbar-brand fw-bold text-dark" href="mechanic-dashboard.php">Smart Track</a>
    <div class="ms-auto">
      <div class="dropdown">
        <button class="btn btn-light border-0 d-flex align-items-center gap-2" id="mechanicDropdown" data-bs-toggle="dropdown" aria-expanded="false">
          <i class="fas fa-user-circle fa-lg text-primary"></i>
          <span class="fw-semibold text-dark d-none d-md-inline">Mechanic</span>
        ...
        ?>
        <ul class="dropdown-menu dropdown-menu-end shadow-sm" aria-labelledby="mechanicDropdown">
          <li><a class="dropdown-item" href="<?= $profilePath ?>"><i class="fas fa-user me-2"></i> My Profile</a></li>
          <li><a class="dropdown-item" href="work-orders.php"><i class="fas fa-tools me-2"></i> My Work Orders</a></li>
