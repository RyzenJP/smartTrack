      ...
      <div class="col-12">
        <div class="card shadow-sm">
          <div class="card-body">
            ...
            <!-- Pagination -->
            <nav aria-label="GPS devices pagination" class="mt-3">
              <div class="d-flex justify-content-between align-items-center">
                <div class="text-muted">
                  <span id="paginationInfo">Showing 0-0 of 0 devices</span>
                </div>
...
<script>
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    // Render GPS devices table with pagination
    function renderGpsTable() {
      const tableBody = document.getElementById('gpsTableBody');
      tableBody.innerHTML = '';
      
      if (!__allGpsDevices || __allGpsDevices.length === 0) {
        tableBody.innerHTML = `
          <tr>
            <td colspan="5" class="text-center text-muted">
              <i class="fas fa-info-circle"></i> No GPS devices found
            </td>
          </tr>`;
      ...
      const totalItems = __allGpsDevices.length;
      ...
      const paginatedData = __allGpsDevices.slice(startIndex, endIndex);
    ...
    function updatePaginationInfo(start, end, total) {
      ...
      if (infoEl) {
        if (total === 0) {
          infoEl.textContent = 'No devices to display';
        } else {
          infoEl.textContent = `Showing ${start}-${end} of ${total} devices`;
        }
      }
    }
    ...
    function updatePaginationControls(totalPages) {
      ...
      html += `
        <li class="page-item ${__currentPage === 1 ? 'disabled' : ''}">
          <a class="page-link" href="#" onclick="changeGpsPage(${__currentPage - 1}); return false;" aria-label="Previous">
      ...
      if (startPage > 1) {
        html += `
          <li class="page-item">
            <a class="page-link" href="#" onclick="changeGpsPage(1); return false;">1</a>
          </li>
        `;
        if (startPage > 2) {
      ...
      for (let i = startPage; i <= endPage; i++) {
        html += `
          <li class="page-item ${i === __currentPage ? 'active' : ''}">
            <a class="page-link" href="#" onclick="changeGpsPage(${i}); return false;">${i}</a>
          </li>
        `;
      }
      ...
      if (endPage < totalPages) {
        ...
        html += `
          <li class="page-item">
            <a class="page-link" href="#" onclick="changeGpsPage(${totalPages}); return false;">${totalPages}</a>
          </li>
        `;
      }
      ...
      html += `
        <li class="page-item ${__currentPage === totalPages ? 'disabled' : ''}">
          <a class="page-link" href="#" onclick="changeGpsPage(${__currentPage + 1}); return false;" aria-label="Next">
    ...
    // Make changeGpsPage accessible globally
    window.changeGpsPage = function(page) {
      if (page < 1) return;
      __currentPage = page;
      renderGpsTable();
